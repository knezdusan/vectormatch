module.exports = [
  ...
  (__turbopack_context__) => {
     ...
     */ const cutOffLoaderExecution = (stack) =>
        ...
        runLoaders(
          {
              ...
              getResolve: (options) => {
                ...
                if (options.aliasFields) {
                  if (!Array.isArray(options.aliasFields)) {
                    throw new Error(
                      "aliasFields resolve option must be an array",
                    );
                  }
                ...
                if (options.extensions) {
                  if (!Array.isArray(options.extensions)) {
                    throw new Error(
                      "extensions resolve option must be an array",
                    );
                  }
                ...
                if (options.mainFields) {
                  if (!Array.isArray(options.mainFields)) {
                    throw new Error(
                      "mainFields resolve option must be an array",
                    );
                  }
                ...
                if (options.mainFiles) {
                  if (!Array.isArray(options.mainFiles)) {
                    throw new Error(
                      "mainFiles resolve option must be an array",
                    );
                  }
              ...
              getLogger(name) {
                ...
                return {
                  ...
                  timeEnd: (label) => {
                    ...
                    const time = process.hrtime(prev);
                    /** @type {Map<string | undefined, [number, number]>} */ timers.delete(
                      label,
                    );
                    logFn(LogType.time, [label, ...time]);
                  },
            ...
            loaders: loadersWithOptions.map((loader) => ({
              loader:
                /*TURBOPACK member replacement*/ __turbopack_context__.x.resolve(
                  loader.loader,
                  {

module.exports = [
  ...
  (a) => {
    ...
    var w = a.i(91419);
    let x = "function" == typeof e.default.unstable_postpone;
    function y(a, b, c) {
      let d = D(
    ...
    function z(a, b, c) {
      (function () {
        ...
        e.default.unstable_postpone(A(a, b));
    }
    function A(a, b) {
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`);
    ...
    a.s(
      [
        ...
        function (a, b) {
          return (
            a.dynamicAccesses.push(...b.dynamicAccesses), a.dynamicAccesses
          );
        },
...
${b}`
        ...
        function (a, b, c, d) {
          if (d.syncDynamicErrorWithStack)
            throw (N(a, d.syncDynamicErrorWithStack), new h());
          if (0 !== b) {
            if (c.hasSuspenseAboveBody) return;
            let d = c.dynamicErrors;
            if (d.length > 0) {
              for (let b = 0; b < d.length; b++) N(a, d[b]);
              throw new h();
            }
        ...
        function (a) {
          ...
          if (b && c)
            switch (c.type) {
              ...
              case "prerender-ppr": {
                let d = c.fallbackRouteParams;
                if (d && d.size > 0) return z(b.route, a, c.dynamicTracking);
                break;
              }
              case "validation-client":
              case "prerender-legacy":
  ...
  (a) => {
    ...
    a.s(["InstantValidationError", 0, j], 60445);
    var k = a.i(32319),
      l = a.i(69825);
    function m(a) {
      (function () {
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      function (a) {
        let f = c.workAsyncStorage.getStore(),
          g = b.workUnitAsyncStorage.getStore();
        if (f && g && "validation-client" === g.type && g.validationSamples) {
          let b = g.fallbackRouteParams;
          if (b && b.size > 0) {
            let c = Array.from(b.keys());
            (0, d.trackMissingSampleErrorAndThrow)(
              Object.defineProperty(
                new e.InstantValidationError(
                  `Route "${f.route}" called ${a} but param${c.length > 1 ? "s" : ""} ${c.map((a) => `"${a}"`).join(", ")} ${c.length > 1 ? "are" : "is"} not defined in the \`samples\` of \`unstable_instant\`. ${a} requires all route params to be provided.`,
                ),
                "__NEXT_ERROR_CODE",
      ...
      function (a) {
        let e = c.workAsyncStorage.getStore(),
          f = b.workUnitAsyncStorage.getStore();
        if (e && f && "validation-client" === f.type && f.validationSamples) {
          let b = new Set(Object.keys(f.validationSamples.params ?? {}));
          return (0, d.createExhaustiveParamsProxy)(a, b, e.route);
        }
        return a;
      },
      ...
      function (a) {
        let e = c.workAsyncStorage.getStore(),
          f = b.workUnitAsyncStorage.getStore();
        if (e && f && "validation-client" === f.type && f.validationSamples) {
          let b = new Set(Object.keys(f.validationSamples.searchParams ?? {}));
          return (0, d.createExhaustiveURLSearchParamsProxy)(a, b, e.route);
        }
        return a;
      },
    ]);
  ...
  (a) => {
    ...
    var b = a.i(87924),
      ...
      f = a.i(32319);
    let g = {
        [d.INSTANT_VALIDATION_BOUNDARY_NAME]: function ({
          id: a,
          children: b,
        }) {
          let c,
            d =
              ...
              "validation-client" === c.type
                ? c.boundaryState
                : null;
          if (null === d)
            throw Object.defineProperty(
              new e.InvariantError("Missing boundary tracking state"),
              "__NEXT_ERROR_CODE",
              { value: "E1060", enumerable: !1, configurable: !0 },
            );
          return d.renderedIds.add(a), b;
        },
      },
      h = (0, c.createContext)(null),
      i = g[d.INSTANT_VALIDATION_BOUNDARY_NAME.slice(0)];
    a.s([
      ...
      0,
      function ({ id: a, children: c }) {
        return (0, b.jsx)(h, { value: a, children: c });
      },
      ...
      function ({ id: a, children: c }) {
        return (0, b.jsx)(i, {
          id: a,
          children: (0, b.jsx)(h, { value: null, children: c }),
        });
      },
    ]);
  },
  ...
  (a) => {
    "use strict";
    let {
      InstantValidationBoundaryContext: b,
      PlaceValidationBoundaryBelowThisLevel: c,
      RenderValidationBoundaryAtThisLevel: d,
    } = a.r(95138);
    a.s([
      "InstantValidationBoundaryContext",
      0,
  ...
  (a) => {
    ...
    var y = a.i(61660),
      ...
      A = a.i(60805),
      B = a.i(38783);
    a.i(28535), a.i(51040), a.i(6634), new TextEncoder();
    var C =
      (((c = {})[(c.Intent = 2)] = "Intent"),
    ...
    a.s(
      [
        ...
        function ({
          ...
          forbidden: o,
          unauthorized: p,
          segmentViewBoundaries: q,
        }) {
          let r = (0, e.useContext)(g.LayoutRouterContext);
          if (!r)
            throw Object.defineProperty(
          ...
          let {
            ...
            E = s[0],
            F = null === u ? [b] : u.concat([E, b]),
            G = s[1][b],
            H = t.slots;
          (void 0 === G || null === H) && (0, e.use)(h);
          let I = null;
          {
            let { InstantValidationBoundaryContext: b } = a.r(51340);
            I = (0, e.use)(b);
          }
          let J = G[0],
            K = H[b] ?? null,
          ...
          do {
            ...
            if ("string" == typeof I) {
              let { RenderValidationBoundaryAtThisLevel: b } = a.r(51340);
              E = (0, d.jsx)(b, { id: I, children: E });
            }
            let G = (0, d.jsxs)(
              g.TemplateContext.Provider,
              { value: E, children: [j, k, l] },
              q,
            );
            (G = (0, d.jsx)(
              e.Activity,
              { name: z, mode: q === O ? "visible" : "hidden", children: G },
              q,
            )),
              Q.push(G),
              (P = P.next);
...
//# sourceMappingURL=node_modules_next_dist_0s23bwm._.js.map

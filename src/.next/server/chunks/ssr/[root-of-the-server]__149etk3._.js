module.exports = [
  ...
  (a) => {
    ...
    a.s(["isThenable", 0, e], 38627);
    let f = process.env.NEXT_OTEL_PERFORMANCE_PREFIX;
    try {
      b = a.r(70406);
    } catch (c) {
      b = a.r(62562);
        ...
        ((c = new (class a {
          ...
          withPropagatedContext(a, b, c, d = !1) {
            ...
            if (d) {
              ...
              let f = h.extract(e, a, c);
              return g.with(f, b);
            }
            if (i.getSpanContext(e)) return b();
            let f = h.extract(e, a, c);
            return g.with(f, b);
          }
          trace(...a) {
            ...
            let m = this.getSpanContext(
              (null == j ? void 0 : j.parentSpan) ?? this.getActiveScopeSpan(),
            );
            m || (m = (null == g ? void 0 : g.active()) ?? l);
            let n = m.getValue(q),
              s = "number" != typeof n || !p.has(n),
              t = r++;
            return (
              (j.attributes = {
                "next.span_name": k,
              ...
              g.with(m.setValue(q, t), () =>
                this.getTracerInstance().startActiveSpan(k, j, (a) => {
                  let c;
                  f &&
                    b &&
                  ...
                  let g = !1,
                    h = () => {
                      !g &&
                        ...
                        c &&
                          performance.measure(
                            `${f}:next-${(b.split(".").pop() || "").replace(/[A-Z]/g, (a) => "-" + a.toLowerCase())}`,
                            { start: c, end: performance.now() },
                          ));
                    };
                  if (
                    (s && p.set(t, new Map(Object.entries(j.attributes ?? {}))),
                    i.length > 1)
                  )
                    try {
                      return i(a, (b) => o(a, b));
    ...
    a.s([
      ...
      function (a) {
        let [c, d, e, f] = a,
          ...
          { page: i } = e;
        i = c === b.DEFAULT_SEGMENT_KEY ? e.defaultPage : i;
        let j = g?.[1] || h?.[1] || i?.[1];
        return {
          page: i,
          segment: c,
      ...
      [
        ...
        function (a, d) {
          let g = (function a(d, f) {
            ...
            { pathnameRouteParamSegments: i, params: k } = (function (a, b) {
              let c = [],
                d = {},
                g = [{ tree: a, depth: 0, currentPath: [] }];
              for (; g.length > 0; ) {
                let { tree: a, depth: i, currentPath: j } = g.shift(),
                  { segment: k, parallelRoutes: l } = (0, f.parseLoaderTree)(a),
                  m = j,
                  n = i,
                  o = e(k);
                if (
                ...
                for (let a of Object.values(l))
                  g.push({ tree: a, depth: n, currentPath: m });
              }
              return { pathnameRouteParamSegments: c, params: d };
            })(d.userland.loaderTree, g),
            l = i.map(({ paramName: a, paramType: b }) => ({
              paramName: a,
              paramType: b,
            }));
          return (
            !(function (a, b, c, d) {
              let g = [{ tree: a, depth: 0 }];
              for (; g.length > 0; ) {
                let { tree: a, depth: i } = g.pop(),
                  { segment: j, parallelRoutes: k } = (0, f.parseLoaderTree)(a),
                  l = e(j);
                if (
                ...
                for (let a of (l &&
                  ...
                  m++,
                Object.values(k)))
                  g.push({ tree: a, depth: m });
              }
            })(d.userland.loaderTree, k, g, l),
            j(l)
          );
        },
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
  ...
  (a) => {
    ...
    class e {
      static #a = (this.EMPTY =
        new e(null, { metadata: {}, contentType: null }));
          ...
          return new Proxy(a, {
            get(a, d, e) {
              if ("get" === d || "getAll" === d || "has" === d) {
                ...
                return (d) => (
                  "string" != typeof d || b.has(d) || n(p(c, d)), f.call(a, d)
                );
              }
              let f = Reflect.get(a, d, e);
  ...
  (a) => {
    ...
    a.s(["DynamicServerError", 0, g, "isDynamicServerError", 0, h], 81793);
    class i extends Error {
      constructor(...a) {
        super(...a), (this.code = "NEXT_STATIC_GEN_BAILOUT");
      }
    }
    a.s(["StaticGenBailoutError", 0, i], 44694);
    var j = a.i(32319);
    a.i(56704);
    let k = "function" == typeof e.default.unstable_postpone;
    function l(a, b, c) {
      (function () {
        if (!k)
          throw Object.defineProperty(
        ...
        e.default.unstable_postpone(m(a, b));
    }
    function m(a, b) {
      ...
      a.s(
        [
          ...
          function ({ reason: a, route: b }) {
            ...
            l(b, a, c && "prerender-ppr" === c.type ? c.dynamicTracking : null);
          },
          ...
          function (a, b, c) {
            ...
            if (!a.forceDynamic && !a.forceStatic) {
              ...
              if (b)
                switch (b.type) {
                  case "prerender-ppr":
                    return l(a.route, c, b.dynamicTracking);
    ...
    var o =
      (((c = {})[(c.Before = 1)] = "Before"),
      (c[(c.EarlyStatic = 2)] = "EarlyStatic"),
      (c[(c.Static = 3)] = "Static"),
      (c[(c.EarlyRuntime = 4)] = "EarlyRuntime"),
      (c[(c.Runtime = 5)] = "Runtime"),
      (c[(c.Dynamic = 6)] = "Dynamic"),
      (c[(c.Abandoned = 7)] = "Abandoned"),
      c);
    a.s(["RenderStage", 0, o], 83187);
    var p = a.i(32885);
    async function q(a) {
      let b,
        c,
        ...
        h = void 0 !== e,
        i = void 0 !== f,
        j = void 0 !== g && a[0] === p.DEFAULT_SEGMENT_KEY;
      return (
        h
    ...
    a.s(["getComponentTypeModule", 0, r, "getLayoutOrPageModule", 0, q], 17524);
    let s = new Set(
    ...
    function t(a) {
      ...
      return "NEXT_HTTP_ERROR_FALLBACK" === b && s.has(Number(c));
    }
    a.s(["isHTTPAccessFallbackError", 0, t], 22298),
      a.i(23932),
      a.i(75164),
      a.i(14976);
    var u = a.i(71717),
      ...
      if (
        ...
        (function (a) {
          ...
          return (
            ...
            "string" == typeof e &&
            !isNaN(f) &&
            f in u.RedirectStatusCode
          );
        })(a) ||
        t(a) ||
        h(a) ||
        n(a) ||
        (0, v.isInstantValidationError)(a)
      )
        return a.digest;
    }
    a.s(["getDigestForWellKnownError", 0, w], 49903);
    var x =
      (((d = {}).ProspectiveRender = "the prospective render"),
      (d.SegmentCollection = "segment collection"),
      (d.InstantValidation = "instant validation"),
      d);
    a.s(
      [
        "Phase",
...
Original Error: ${d}`),
            ...
            if (d)
              return void console.error(`Route ${b} errored during ${c}. These errors are normally ignored and may not prevent the route from prerendering but are logged here because build debugging is enabled. No stack was provided.
...
Original Message: ${d}`);
  ...
  (a, b, c) => {
    ...
    a.n(
      d(
        "[project]/node_modules/next/dist/esm/client/components/instant-validation/boundary.js <module evaluation>",
      ),
    );
  },
  11319,
  (a, b, c) => {
    ...
    a.n(
      d(
        "[project]/node_modules/next/dist/esm/client/components/instant-validation/boundary.js",
      ),
    );
  },
  54956,
  ...
  (a) => {
    ...
    function k(a, ...b) {
      return new Promise((d, e) => {
              ...
              return function (f) {
                if (j)
                  throw Object.defineProperty(
                    ...
                    "__NEXT_ERROR_CODE",
                    { value: "E935", enumerable: !1, configurable: !0 },
                  );
                let k = setTimeout(e ? b : d, a, f);
                if (((e = !1), !g)) return k;
                try {
                  "_idleStart" in k && "number" == typeof k._idleStart
                    ? null === i
                      ? (i = k._idleStart)
                      : (k._idleStart = i)
                    : ((g = !1), h());
                  ...
                  console.error(
                    Object.defineProperty(
                      ...
                      "__NEXT_ERROR_CODE",
                      { value: "E933", enumerable: !1, configurable: !0 },
                    ),
                  ),
                    (g = !1),
                    h();
        ...
        m.push(
          l(() => {
            try {
              (0, f.DANGEROUSLY_runPendingImmediatesAfterCurrentTask)(),
                (k = a()),
                (0, i.isThenable)(k) && k.then(j, j);
            } catch (a) {
              for (let a = 1; a < m.length; a++) clearTimeout(m[a]);
              e(a);
            }
          }),
        );
        for (let a = 0; a < b.length; a++) {
          ...
          m.push(
            l(() => {
              try {
                (0, f.DANGEROUSLY_runPendingImmediatesAfterCurrentTask)(), c();
              } catch (a) {
                for (; ++d < m.length; ) clearTimeout(m[d]);
                e(a);
              }
            }),
          );
        ...
        m.push(
          l(() => {
            try {
              (0, f.expectNoPendingImmediates)(), d(k);
            } catch (a) {
              e(a);
            }
          }),
    ...
    function s(b, c, d) {
      {
        let { Readable: e } = a.r(81111),
          f = 0,
          g = new e({
            read() {
              for (; f < b.length; ) this.push(b[f]), f++;
            },
          });
        return (
          d.addEventListener(
            "abort",
            () => {
              for (; f < b.length; ) g.push(b[f]), f++;
              for (; f < c.length; ) g.push(c[f]), f++;
              setImmediate(() => {
                g.push(null);
              });
            },
    ...
    function t(b, c) {
      {
        ...
        let e = 0,
          f = new d({
            read() {
              for (; e < b.length; ) this.push(b[e]), e++;
              c || this.push(null);
            },
          });
        return f;
    ...
    let y,
      z,
      A =
        "1" === process.env.NEXT_PRIVATE_DEBUG_VALIDATION
          ? console.log
          : void 0;
    function B(a, b, c) {
      let d = "children" === b ? "" : `@${encodeURIComponent(b)}/`;
      return `${a}/${d}${C(c)}`;
    }
    function C(a) {
      return "string" == typeof a
        ? encodeURIComponent(a)
        : encodeURIComponent(a[0]) + "|" + a[1] + "|" + a[2];
    }
    async function D(a, b, f, g, h) {
      let i = new AbortController(),
        j = b ? t(b, i.signal) : null,
        { stream: o, controller: p } = (function (a) {
          let b = a[d.RenderStage.Dynamic],
            c = a[d.RenderStage.Static].length,
            e = a[d.RenderStage.Runtime].length,
            f = a[d.RenderStage.Dynamic].length,
            g = 0,
            h = d.RenderStage.Static,
            i = !1;
          function j(a) {
            l.push(a);
          }
          ...
          let l = new r.Readable({
            read() {
              for (; g < c; g++) j(b[g]);
              if (g >= b.length) return void k();
            },
          });
          return {
            stream: l,
            controller: {
              ...
              advanceStage: function (a) {
                if (i) return !0;
                switch (a) {
                  case d.RenderStage.Runtime:
                    for (h = d.RenderStage.Runtime; g < e; g++) j(b[g]);
                    break;
                  case d.RenderStage.Dynamic:
                    for (h = d.RenderStage.Dynamic; g < f; g++) j(b[g]);
                }
                return g >= b.length && (k(), !0);
              },
            },
          };
        })(a);
      o.on("end", () => {
        setImmediate(() => i.abort());
      });
      let q = () => {
          let a = p.currentStage;
          switch (a) {
            case d.RenderStage.Static:
              return "Prerender";
            case d.RenderStage.Runtime:
              return g ? "Prefetch" : "Prefetchable";
            case d.RenderStage.Dynamic:
              return "Server";
            default:
              throw Object.defineProperty(
                new c.InvariantError(`Invalid render stage: ${a}`),
                "__NEXT_ERROR_CODE",
        ...
        s = {
          moduleLoading: null,
          moduleMap: h.rscModuleMapping,
          serverModuleMap: (0, e.getServerModuleMap)(),
        },
        x = await (0, v.createFromNodeStream)(o, s, {
          findSourceMapURL: z,
          debugChannel: j ?? void 0,
          startTime: void 0,
          endTime: void 0,
        }),
        { head: A } = F(x),
        D = new Map();
      !(function (a, b) {
        let { flightRouterState: d, seedData: e } = F(a),
          [f] = d;
        !(function a(b, d, e, f) {
          f(b, e);
          let [g, h] = d,
          ...
          for (let d in h) {
            ...
            if (!e)
              throw Object.defineProperty(
                ...
                "__NEXT_ERROR_CODE",
                { value: "E992", enumerable: !1, configurable: !0 },
              );
            let g = h[d],
              [i] = g;
            a(B(b, d, i), g, e, f);
        ...
        D.set(
          ...
          (function (a) {
            let [b, c, d, e, f] = a;
            return { node: b, isPartial: e, varyParams: f };
          })(b),
        );
      });
      let E = { head: null, segments: new Map() },
        G = [],
        H = { [d.RenderStage.Static]: -1, [d.RenderStage.Runtime]: -1 },
        I = async (a, b) => {
          let c = b.debugChunks ? u() : void 0,
            e = (0, w.renderToReadableStream)(a, h.clientModules, {
              filterStackFrame: y,
              debugChannel: null == c ? void 0 : c.serverSide,
              environmentName: q,
              startTime: f,
              onError(a) {
                let b = (0, n.getDigestForWellKnownError)(a);
                if (b) return b;
                if (
                  a &&
                  "object" == typeof a &&
                ...
                if (
                  ...
                  (0, m.printDebugThrownValueForProspectiveRender)(
                    a,
                    (null == b ? void 0 : b.route) ?? "unknown route",
                    m.Phase.InstantValidation,
                  );
                }
              },
            });
          await Promise.all([
            (async () => {
              for await (let g of e.values()) {
                var a = b.chunks,
                  c = p.currentStage,
                  f = g;
                switch (c) {
                  case d.RenderStage.Static:
                    a[d.RenderStage.Static].push(f);
                  case d.RenderStage.Runtime:
                    a[d.RenderStage.Runtime].push(f);
                  case d.RenderStage.Dynamic:
                    a[d.RenderStage.Dynamic].push(f);
                }
              }
            })(),
            c &&
              (async () => {
                for await (let a of c.clientSide.readable.values())
                  b.debugChunks.push(a);
              })(),
          ]);
        };
      return (
        await k(
          () => {
            {
              let a = J(!!b);
              (E.head = a), G.push(I(A, a));
            }
            for (let [a, c] of D) {
              let d = J(!!b);
              E.segments.set(a, d), G.push(I(c, d));
            }
          },
          () => {
            (H[d.RenderStage.Static] =
              performance.now() + performance.timeOrigin),
              p.advanceStage(d.RenderStage.Runtime);
          },
          () => {
            (H[d.RenderStage.Runtime] =
              performance.now() + performance.timeOrigin),
              p.advanceStage(d.RenderStage.Dynamic);
          },
        ),
        await Promise.all(G),
        { cache: E, payload: x, stageEndTimes: H }
      );
    }
    async function E(a, b, c, d, e, f) {
      let g,
        h = !0,
        i = [],
        j = [],
      ...
      return (
        await k(
          () => {
            let b = (0, w.renderToReadableStream)(a, d.clientModules, {
              filterStackFrame: y,
              debugChannel: null == p ? void 0 : p.serverSide,
              startTime: e,
              onError(a) {
                let b = (0, n.getDigestForWellKnownError)(a);
                if (b) return b;
            ...
            g = Promise.all([
              (async () => {
                for await (let a of b.values()) j.push(a), h && i.push(a);
              })(),
              p &&
                (async () => {
                  for await (let a of p.clientSide.readable.values()) o.push(a);
                })(),
            ]);
          },
          () => {
        ...
        await g,
        { stream: s(i, j, c), debugStream: o ? t(o, c) : null }
      );
    }
    function F(a) {
      let b = a.f;
      if (1 !== b.length && 3 !== b[0].length)
        throw Object.defineProperty(
          new c.InvariantError(
            "InitialRSCPayload does not match the expected shape during instant validation.",
          ),
          "__NEXT_ERROR_CODE",
          { value: "E994", enumerable: !1, configurable: !0 },
        );
      let d = b[0][0];
      return { flightRouterState: d, seedData: b[0][1], head: b[0][2] };
    }
    async function G(a, b, e, f, g) {
      let h = a.head;
      if (!h)
        throw Object.defineProperty(
          new c.InvariantError("Missing segment data: <head>"),
          "__NEXT_ERROR_CODE",
          { value: "E1072", enumerable: !1, configurable: !0 },
        );
      return await H(
        h.chunks[g],
        h.chunks[d.RenderStage.Dynamic],
        h.debugChunks,
        b,
        e,
        { startTime: void 0, endTime: f[g] },
      );
    }
    function H(a, b, c, d, f, g) {
      let h = new AbortController(),
        i = c ? t(c, h.signal) : null,
        j = {
          moduleLoading: null,
          moduleMap: f.rscModuleMapping,
          serverModuleMap: (0, e.getServerModuleMap)(),
        },
        k = a.length < b.length ? s(a, b, d) : t(a);
      return (
        k.on("end", () => {
          setImmediate(() => h.abort());
        }),
        (0, v.createFromNodeStream)(k, j, {
          findSourceMapURL: z,
          debugChannel: i ?? void 0,
          startTime: null == g ? void 0 : g.startTime,
          endTime: null == g ? void 0 : g.endTime,
        })
      );
    }
    function I(a, b) {
      return [a.node, b, null, a.isPartial, a.varyParams];
    }
    function J(a) {
      return {
        chunks: {
          [d.RenderStage.Static]: [],
          [d.RenderStage.Runtime]: [],
          [d.RenderStage.Dynamic]: [],
        },
        debugChunks: a ? [] : null,
      };
    }
    function K(a) {
      return (
        "string" != typeof a ||
        (!(a.startsWith(x.PAGE_SEGMENT_KEY) || (0, x.isGroupSegment)(a)) &&
          a !== x.DEFAULT_SEGMENT_KEY &&
          a !== x.NOT_FOUND_SEGMENT_KEY)
      );
    }
    async function L(a, e, f, g, h, i, j, k, l, m, n, r) {
      let s = !1,
        t = !1;
      function u(a) {
        let b = g(a);
        if (b) return b.treeSegment;
        let c = a[0];
        return h ? (0, x.addSearchParamsIfPageSegment)(c, h) : c;
      }
      async function v(a, f, g, h, n) {
        let { parallelRoutes: p } = (0, q.parseLoaderTree)(a),
          r = u(a),
          s = null === f ? C(r) : B(f, g, r);
        null == A || A(`    ${s || "/"} - Dynamic`);
        let t = e.segments.get(s);
        if (!t)
          throw Object.defineProperty(
            new c.InvariantError(`Missing segment data: ${s}`),
            "__NEXT_ERROR_CODE",
            { value: "E995", enumerable: !1, configurable: !0 },
          );
        let y = await H(
            t.chunks[d.RenderStage.Dynamic],
            t.chunks[d.RenderStage.Dynamic],
            t.debugChunks,
            k,
            m,
          ...
          D =
            "string" == typeof r &&
            (0, x.isGroupSegment)(r) &&
            "(__SLOT__)" !== r,
          E = h,
          F = n;
        if ((z ? (E++, (F = 0)) : D && F++, E > i && F >= j)) {
          null == A || A(`    ['${s}' is the boundary (url=${E}, group=${F})]`),
            l.expectedIds.add(s);
          let a = {
              ...y,
              node: (0, b.jsx)(
                o.PlaceValidationBoundaryBelowThisLevel,
                { id: s, children: y.node },
                "c",
              ),
            },
            c = {},
            ...
            e = null;
          for (let a in p) {
            let b = await w(p[a], s, a, !1);
            (c[a] = b.seedData),
              b.requiresInstantUI &&
                ((d = !0), null === e && (e = b.createInstantStack));
          }
          return {
            seedData: I(a, c),
            requiresInstantUI: d,
        ...
        let G = {},
          ...
          L = null;
        for (let a in p) {
          let b = await v(p[a], s, a, E, F);
          (G[a] = b.seedData),
            b.requiresInstantUI &&
              ((J = !0), null === L && (L = b.createInstantStack));
        }
        return {
          seedData: I(y, G),
          requiresInstantUI: J,
          createInstantStack: L,
        };
      }
      async function w(a, b, f, g) {
        let h,
          i,
          j,
          { parallelRoutes: l } = (0, q.parseLoaderTree)(a),
          { mod: o } = await (0, p.getLayoutOrPageModule)(a),
          v = u(a),
          x = null === b ? C(v) : B(b, f, v),
          y = null,
          z = null;
        if (
          void 0 !== o &&
          (y = o.unstable_instant ?? null) &&
          "object" == typeof y
        ) {
          let a = o.__debugCreateInstantConfigStack;
          z = "function" == typeof a ? a : null;
        }
        let D = g;
        g
          ? ((h = d.RenderStage.Runtime), (t = !0))
          : y && "object" == typeof y && "runtime" === y.prefetch
            ? ((h = d.RenderStage.Runtime), (D = !0), (t = !0))
            : r
              ? ((h = d.RenderStage.Runtime), (t = !0))
              : ((h = d.RenderStage.Static), (s = !0)),
          null == A || A(`    ${x || "/"} - ${d.RenderStage[h]}`);
        let E = e.segments.get(x);
        if (!E)
          throw Object.defineProperty(
            new c.InvariantError(`Missing segment data: ${x}`),
            "__NEXT_ERROR_CODE",
            { value: "E995", enumerable: !1, configurable: !0 },
          );
        let F = await H(
            E.chunks[h],
            E.chunks[d.RenderStage.Dynamic],
            E.debugChunks,
            k,
            m,
            { startTime: void 0, endTime: n[h] },
          ),
          G = {},
          J = !1,
          K = null;
        for (let a in l) {
          let b = await w(l[a], x, a, D);
          (G[a] = b.seedData),
            b.requiresInstantUI &&
              ((J = !0), null === K && (K = b.createInstantStack));
        }
        return (
          !1 === y
            ? ((i = !1), (j = null))
            : y && "object" == typeof y
              ? ((i = !0), (j = z))
              : ((i = J), (j = K)),
          { seedData: I(F, G), requiresInstantUI: i, createInstantStack: j }
        );
      }
      let {
        seedData: y,
        requiresInstantUI: z,
        createInstantStack: D,
      } = await v(f, null, null, 0, 0);
      if (!z) return null;
      let { flightRouterState: E } = F(a),
        J = t ? d.RenderStage.Runtime : d.RenderStage.Static,
        L = await G(e, k, m, n, J);
      return {
        payload: { ...a, f: [[E, y, L]] },
        hasAmbiguousErrors: s,
        createInstantStack: D,
      };
    }
    a.s(
      [
        ...
        function (a) {
          let b = [];
          function c(a, c) {
            for (; b.length <= a; ) b.push(0);
            c > b[a] && (b[a] = c);
          }
          return (
            !(function a(b, d, e) {
              let f = b[0],
                { parallelRoutes: g } = (0, q.parseLoaderTree)(b),
                h = K(f),
                i = d,
                j = e;
              for (let b in (h
  ...
  (a) => {
    ...
    var h = a.i(56704),
      i = a.i(32319);
    function j() {
      let a = i.workUnitAsyncStorage.getStore();
      if (a)
        switch (a.type) {
          case "prerender":
    ...
    function l(a, b, c) {
      if (null !== c)
        return new Proxy(b, {
          ...
          has: (b, d) => (d === c && k(a, c), Reflect.has(b, d)),
          ownKeys: (b) => (k(a, c), Reflect.ownKeys(b)),
        });
      let d = {};
      for (let c in b)
    ...
    function t() {}
    let u = { current: null },
      v = "function" == typeof g.cache ? g.cache : (a) => a,
      w = console.error;
    function x(a) {
      return function (...b) {
        w(a(...b));
    ...
    function B(b, c, d) {
      ...
      if (!e)
        throw Object.defineProperty(
          new o.InvariantError("Expected workStore to be initialized"),
          "__NEXT_ERROR_CODE",
          { value: "E1068", enumerable: !1, configurable: !0 },
        );
      let f = i.workUnitAsyncStorage.getStore();
      if (f)
        switch (f.type) {
          case "prerender":
                    ...
                    g = new Proxy(f, {
                      get(a, b, c) {
                        if (Object.hasOwn(f, b))
                          return m.ReflectAdapter.get(a, b, c);
                        switch (b) {
                          case "then":
                            return (
                              (0, n.annotateDynamicAccess)(
                                "`await searchParams`, `searchParams.then`, or similar",
                                d,
                              ),
                              m.ReflectAdapter.get(a, b, c)
                            );
                          case "status":
                            return (
                              (0, n.annotateDynamicAccess)(
                      ...
                      get(a, b, c) {
                        ...
                        if ("string" == typeof b && "then" === b) {
                          ...
                          "prerender-ppr" === i.type
                            ...
                            : (0, n.throwToInterruptStaticGeneration)(a, h, i);
                        }
                        return m.ReflectAdapter.get(a, b, c);
                      },
                    });
          ...
          case "prerender-runtime":
            return (function (a, b, c, d) {
              let e = D(
                ...
                { stagedRendering: f } = b;
              if (!f) return e;
              let g = d ? p.RenderStage.EarlyRuntime : p.RenderStage.Runtime;
              return f.waitForStage(g).then(() => e);
            })(b, f, c, d);
          case "request":
            return (function (b, c, d, e) {
              if (c.forceStatic) return Promise.resolve({});
              if (!d.asyncApiPromises) return D(b);
    ...
    function G(b, c, d, e) {
      let f = h.workAsyncStorage.getStore();
      if (!f)
        throw Object.defineProperty(
          new o.InvariantError("Expected workStore to be initialized"),
          "__NEXT_ERROR_CODE",
      ...
      let g = i.workUnitAsyncStorage.getStore();
      if (g)
        switch (g.type) {
          case "prerender":
          case "prerender-client":
          ...
          case "prerender-legacy":
            var j = b,
              ...
              q = g,
              r = d;
            let t = null !== r ? l(r, j, k) : j;
            switch (q.type) {
              case "prerender":
              case "prerender-client": {
                let a = q.fallbackRouteParams;
                if (a) {
                  for (let b in j)
                    if (a.has(b))
                      return (function (a, b, c) {
                      ...
                      return (function (a, b, c, d) {
                        ...
                        return (
                          ...
                          Object.keys(a).forEach((a) => {
                            y.wellKnownProperties.has(a) ||
                              (b.has(a) &&
                                Object.defineProperty(f, a, {
                                  get() {
                                    let b = (0, y.describeStringPropertyAccess)(
                                      "params",
                                      a,
                                    );
          ...
          case "prerender-runtime":
            return (function (a, b, c, d, e) {
              let f = J(null !== d ? l(d, a, b) : a),
                { stagedRendering: g } = c;
              if (!g) return f;
              let h = e ? p.RenderStage.EarlyRuntime : p.RenderStage.Runtime;
      ...
      I = {
        get: function (a, b, c) {
          if ("then" === b || "catch" === b || "finally" === b) {
            let d = m.ReflectAdapter.get(a, b, c);
            return {
              [b]: (...b) => {
                let c = E.dynamicAccessAsyncStorage.getStore();
                return (
                  c &&
              ...
              switch (c.type) {
                ...
                case "prerender-client":
                  ...
                  if (d) {
                    for (let e in a)
                      if (d.has(e))
                        return s(c.renderSignal, b.route, "`params`");
                  }
                  break;
                case "validation-client":
                  throw Object.defineProperty(
    ...
    function R(a, b) {
      ...
      b || (b = Q());
      let c = b.pathname || "";
      return new URL(O.default.posix.join(c, a), b);
    }
    let S = /^(?:\/((?!\.well-known(?:\/.*)?)(?:[^/]+\/)*[^/]+\.\w+))(\/?|$)/i;
    function T(a, b, c, { trailingSlash: d }) {
      var e, f;
      a =
        "string" == typeof (e = a) && e.startsWith("./")
          ? O.default.posix.resolve(c, e)
          : e;
      let g = "",
        h = b ? R(a, b) : a;
      if (
    ...
    function aa(a, b, c) {
      ...
      for (let a of d) {
        let d = (function (a, b, c) {
          ...
          if ("string" == typeof e && !(0, W.isFullStringUrl)(e) && (!b || c)) {
            let a = (function (a) {
              let b,
                c,
                d = Q(),
          ...
          return d ? { url: R(e, b) } : { ...a, url: R(e, b) };
        })(a, b, c);
        d && e.push(d);
      }
      return e;
    ...
    let ab = {
      ...
      ac = async (a, b, c, d, e) => {
        var f;
        if (!a) return null;
        let g = { ...a, title: V(a.title, e) };
        for (let b of (f = a && "type" in a ? a.type : void 0) && f in ab
          ? ab[f].concat(_)
          : _)
          if (b in a && "url" !== b) {
            let c = a[b];
        ...
        return (
          (g.images = aa(a.images, b, d.isStaticMetadataRouteFile)),
          (g.url = a.url ? T(a.url, b, await c, d) : null),
          g
        );
      },
      ad = ["site", "siteId", "creator", "creatorId", "description"],
      ae = (a, b, c, d) => {
        var e;
        if (!a) return null;
        let f = "card" in a ? a.card : void 0,
          g = { ...a, title: V(a.title, d) };
        for (let b of ad) g[b] = a[b] || null;
        if (
          ((g.images = aa(a.images, b, c.isStaticMetadataRouteFile)),
          (f =
            f ||
    ...
    let ak = async (a, b, c, d) => {
      ...
      as = async (a, b, c, d) =>
        a
          ...
          : null,
      at = (a) => (a ? { appId: a.appId, admins: N(a.admins) } : null),
      au = async (a, b, c, d) => ({
      ...
      av = ["icon", "shortcut", "apple", "other"];
    function aw(a) {
      return P(a) ? { url: a } : (Array.isArray(a), a);
    }
    let ax = (a) => {
      if (!a) return null;
      let b = { icon: [], apple: [] };
      if (Array.isArray(a)) b.icon = a.map(aw).filter(Boolean);
      else if (P(a)) b.icon = [aw(a)];
      else
        for (let c of av) {
          let d = N(a[c]);
          d && (b[c] = d.map(aw));
    ...
    function aD(a) {
      ...
      if (Array.isArray(a)) return a.map((a) => aD(a));
      if (a && "object" == typeof a) {
        let b = {};
        for (let [c, d] of Object.entries(a)) b[c] = aD(d);
        return b;
      }
      return a;
    }
    ...
    async function aF(a, b, c, d, e, f, g, h) {
      var i, j;
      if (!d) return c;
    ...
    async function aG(
      ...
      for (let d in c)
        switch (d) {
          case "title":
            j.title = V(c.title, f.title);
            break;
          case "alternates":
            j.alternates = aD(await ak(c.alternates, k, b, g));
            break;
          case "openGraph":
            j.openGraph = aD(await ac(c.openGraph, k, b, g, f.openGraph));
            break;
          case "twitter":
            j.twitter = aD(ae(c.twitter, k, g, f.twitter));
            break;
          case "facebook":
          ...
          case "verification":
            ...
            break;
          case "icons":
            j.icons = aD(ax(c.icons));
            break;
          case "appleWebApp":
            j.appleWebApp = aq(c.appleWebApp);
            break;
          case "appLinks":
            j.appLinks = aD(ar(c.appLinks));
            break;
          case "robots":
...
Read more: https://nextjs.org/docs/app/api-reference/functions/generate-viewport`);
      ...
      return aF(k, c, j, e, g, f, i, b);
    }
    function aH(a, b, c) {
      if ("function" == typeof a.generateViewport) {
        let { route: d } = c,
          e = aJ(a.generateViewport, b);
        return Object.assign(
          (b) =>
            (0, ay.getTracer)().trace(
              az.ResolveMetadataSpan.generateViewport,
              {
    ...
    function aI(a, b, c) {
      if ("function" == typeof a.generateMetadata) {
        let { route: d } = c,
          e = aJ(a.generateMetadata, b);
        return Object.assign(
          (b) =>
            (0, ay.getTracer)().trace(
              az.ResolveMetadataSpan.generateMetadata,
              {
    ...
    async function aM({
      ...
      let g,
        h,
        i = !!(f && a[2][f]);
      if (f) (g = await (0, af.getComponentTypeModule)(a, "layout")), (h = f);
      else {
        let { mod: b, modType: c } = await (0, af.getLayoutOrPageModule)(a);
        (g = b), (h = c);
      }
      h && (e += `/${h}`);
      let j = await aL(a[2], d),
        k = g ? aI(g, d, { route: e }) : null;
      if ((b.push([k, j]), i && f)) {
        let b = await (0, af.getComponentTypeModule)(a, f),
          g = b ? aI(b, d, { route: e }) : null;
        (c[0] = g), (c[1] = j);
      }
    }
    async function aN({
      ...
      h && (e += `/${h}`);
      let j = g ? aH(g, d, { route: e }) : null;
      if ((b.push(j), i && f)) {
        let b = await (0, af.getComponentTypeModule)(a, f);
        c.current = b ? aH(b, d, { route: e }) : null;
      }
    }
    let aO = (0, g.cache)(async function (a, b, c, d, e) {
      return aP([], a, void 0, {}, null, b, c, [null, null], d, e);
    });
    async function aP(a, b, c, d, e, f, g, h, i, j) {
      let [k, l, { page: m }] = b,
        n = c && c.length ? [...c, k] : [k],
        o = d,
        p = (0, L.getSegmentParam)(k);
      if (p) {
        let a = i[p.paramName];
      ...
      let q =
          ...
          (null === i[p.paramName] || void 0 === i[p.paramName])
            ...
            : e,
        r = F(o, q, j);
      for (let c in (await aM({
        tree: b,
        metadataItems: a,
        errorMetadataItem: h,
        errorConvention: g,
        props: void 0 !== m ? { params: r, searchParams: f } : { params: r },
        route: n.filter((a) => a !== aA.PAGE_SEGMENT_KEY).join("/"),
      }),
      l)) {
        let b = l[c];
        await aP(a, b, n, o, q, f, g, h, i, j);
      }
      return 0 === Object.keys(l).length && g && a.push(h), a;
    }
    let aQ = (0, g.cache)(async function (a, b, c, d, e) {
      return aR([], a, void 0, {}, null, b, c, { current: null }, d, e);
    });
    async function aR(a, b, c, d, e, f, g, h, i, j) {
      let k,
        [l, m, { page: n }] = b,
        o = c && c.length ? [...c, l] : [l],
        p = d,
        q = (0, L.getSegmentParam)(l);
      if (q) {
        let a = i[q.paramName];
      ...
      await aN({
        ...
        errorConvention: g,
        props: k,
        route: o.filter((a) => a !== aA.PAGE_SEGMENT_KEY).join("/"),
      }),
      m)) {
        let b = m[c];
        await aR(a, b, o, p, r, f, g, h, i, j);
      }
      return 0 === Object.keys(m).length && g && a.push(h.current), a;
    }
    let aS = (a) => !!(null == a ? void 0 : a.absolute),
      aT = (a) => aS(null == a ? void 0 : a.title);
    function aU(a, b) {
      a &&
        (!aT(a) && aT(b) && (a.title = b.title),
    ...
    function aW(a, b) {
      if ("function" == typeof b) {
        ...
        if (d && d.usedArgs[1]) {
          ...
          let c;
          d ? (a.push(aV), (c = b())) : (c = b(new Promise((b) => a.push(b)))),
            a.push(c),
    ...
    async function aX(a, b, c, d) {
      let e,
        ...
        j = (function (a) {
          let b = [];
          for (let c = 0; c < a.length; c++) aW(b, a[c][0]);
          return b;
        })(b),
        k = 0;
      ...
      if (
        ...
        for (let a of h.warnings) X.warn(a);
      return (function (a, b, c, d) {
        ...
        if (e) {
          ...
          if (
            (!g &&
              (aS(e.title)
                ? (b.title = e.title)
                : a.title && aS(a.title) && (b.title = a.title)),
            h || (b.description = e.description || a.description || void 0),
            i || (b.images = e.images),
            Object.keys(b).length > 0)
          ) {
            let e = ae(b, aE(a.metadataBase), d, c.twitter);
            a.twitter
    ...
    async function aY(a) {
      let b = {
        ...
        c = (function (a) {
          let b = [];
          for (let c = 0; c < a.length; c++) aW(b, a[c]);
          return b;
        })(a),
        d = 0;
      for (; d < c.length; ) {
        ...
        b = (function ({ resolvedViewport: a, viewport: b }) {
          ...
          return c;
        })({ resolvedViewport: b, viewport: a_(a) ? await a : a });
      }
      return b;
    }
    async function aZ(a, b, c, d, e, f, g) {
      let i = await aO(a, c, d, e, g),
        j = h.workAsyncStorage.getStore();
      if (!j)
        throw Object.defineProperty(
          new o.InvariantError("Expected workStore to be initialized"),
          "__NEXT_ERROR_CODE",
      ...
      return aX(j.route, i, b, f);
    }
    async function a$(a, b, c, d, e) {
      return aY(await aQ(a, b, c, d, e));
    }
    function a_(a) {
    ...
    function a3(a) {
      return "object" == typeof a && null !== a && a.$$typeof === a2;
    }
    var a4 = a.i(82622),
      a5 = a.i(6983);
    let a6 = (0, g.cache)(a7);
    async function a7(a, b, c, d, e, f, g) {
      return be(a, b, c, d, e, f, "redirect" === g ? void 0 : g);
    }
    let a8 = (0, g.cache)(a9);
    async function a9(a, b, c, d, e, f) {
      return be(a, b, c, d, e, f, "not-found");
    }
    let ba = (0, g.cache)(bb);
    async function bb(a, b, c, d, e) {
      return bf(a, b, c, d, "redirect" === e ? void 0 : e);
    }
    let bc = (0, g.cache)(bd);
    async function bd(a, b, c, d) {
      return bf(a, b, c, d, "not-found");
    }
    async function be(a, b, c, d, e, f, g) {
      let h = await aZ(a, b, c, g, d, e, f);
      return (0, K.jsx)(K.Fragment, {
        children: (function (a) {
          ...
          if (
            (null !== a.title &&
              a.title.absolute &&
              g.push((0, K.jsx)("title", { children: a.title.absolute }, h++)),
            a.description &&
              g.push(
                (0, K.jsx)(
                  "meta",
          ...
          if (
            ...
            for (let b of a.archives)
              g.push((0, K.jsx)("link", { rel: "archives", href: b }, h++));
          if (a.assets)
            for (let b of a.assets)
              g.push((0, K.jsx)("link", { rel: "assets", href: b }, h++));
          if (a.bookmarks)
            for (let b of a.bookmarks)
              g.push((0, K.jsx)("link", { rel: "bookmarks", href: b }, h++));
          if (
            (a.pagination &&
              ...
              if (Array.isArray(c))
                for (let a of c)
                  null != a &&
                    "" !== a &&
                    g.push(
                      (0, K.jsx)("meta", { name: b, content: String(a) }, h++),
                    );
              else
                null != c &&
                  "" !== c &&
                  g.push(
                    (0, K.jsx)("meta", { name: b, content: String(c) }, h++),
                  );
          if (a.alternates) {
            let {
              canonical: b,
          ...
          if (
            ...
            for (let b of a.facebook.admins)
              g.push(
                (0, K.jsx)("meta", { property: "fb:admins", content: b }, h++),
              );
          if (
            (a.pinterest &&
            ...
            if (b.me)
              for (let a of b.me)
                null != a &&
                  "" !== a &&
                  g.push(
                    (0, K.jsx)("meta", { name: "me", content: String(a) }, h++),
                  );
            if (b.other)
              for (let [a, c] of Object.entries(b.other))
                for (let b of c)
                  null != b &&
                    "" !== b &&
                    g.push(
                      (0, K.jsx)("meta", { name: a, content: String(b) }, h++),
                    );
          }
          if (a.appleWebApp) {
            let {
          ...
          if (a.openGraph) {
            ...
            if (b.emails)
              for (let a of b.emails)
                g.push(
                  (0, K.jsx)("meta", { property: "og:email", content: a }, h++),
                );
            if (b.phoneNumbers)
          ...
          if (a.twitter) {
            ...
            if (
              (c &&
                g.push(
                  (0, K.jsx)("meta", { name: "twitter:card", content: c }, h++),
                ),
              b.site &&
                g.push(
                  (0, K.jsx)(
          ...
          if (a.icons) {
            ...
            f && g.push((0, K.jsx)(a5.IconMark, {}, h++));
          }
          return g;
        })(h),
      });
    }
    async function bf(a, b, c, d, e) {
      let f = await a$(a, b, e, c, d);
      return (0, K.jsx)(K.Fragment, {
        children: (function (a) {
          let b = [],
            c = 0;
          b.push((0, K.jsx)("meta", { charSet: "utf-8" }, c++));
          let d = [];
          if (
        ...
        function ({
                  ...
                  case "prerender-runtime":
                    return (function (a, b) {
                      ...
                      return c
                        ? c
                            .waitForStage(
                              c.currentStage === p.RenderStage.EarlyStatic ||
                                c.currentStage === p.RenderStage.EarlyRuntime
                                ? p.RenderStage.EarlyRuntime
                                : p.RenderStage.Runtime,
                            )
                            .then(() => b)
                        : b;
                    })(c, a1(a));
          ...
          async function q() {
            if (!k) {
              let a = i.workUnitAsyncStorage.getStore();
              if (a) {
                let b = (0, i.getStagedRenderingController)(a);
                b && (await b.waitForStage(p.RenderStage.Static));
              }
            }
            return await ba(a, l, e, k, f).catch((b) => {
              if (a3(b)) throw b;
              return !f && (0, a0.isHTTPAccessFallbackError)(b)
                ? bc(a, l, e, k).catch(() => null)
                : null;
            });
          }
          async function r() {
            ...
            return await a6(a, m, l, e, d, k, f).catch((b) => {
              if (a3(b)) throw b;
              return !f && (0, a0.isHTTPAccessFallbackError)(b)
                ? a8(a, m, l, e, d, k).catch(() => null)
                : null;
            });
          }
          function t() {
            ...
            return j
              ? (0, K.jsx)(a4.OutletBoundary, {
                  children: (0, K.jsx)(g.Suspense, {
                    name: "Next.MetadataOutlet",
                    children: b,
                  }),
                })
              : (0, K.jsx)(a4.OutletBoundary, { children: b });
          }
          return (
            (q.displayName = "Next.Viewport"),
            (r.displayName = "Next.Metadata"),
            (t.displayName = "Next.MetadataOutlet"),
            {
              Viewport: function () {
                return (0, K.jsx)(a4.ViewportBoundary, {
                  children: (0, K.jsx)(q, {}),
                });
              },
              Metadata: function () {
                return j
                  ? (0, K.jsx)("div", {
                      hidden: !0,
                      children: (0, K.jsx)(a4.MetadataBoundary, {
                        children: (0, K.jsx)(g.Suspense, {
                          name: "Next.Metadata",
                          children: (0, K.jsx)(r, {}),
                        }),
    ...
    var bh =
      (((e = {})[(e.HasRuntimePrefetch = 1)] = "HasRuntimePrefetch"),
      (e[(e.SubtreeHasInstant = 2)] = "SubtreeHasInstant"),
      (e[(e.SegmentHasLoadingBoundary = 4)] = "SegmentHasLoadingBoundary"),
      (e[(e.SubtreeHasLoadingBoundary = 8)] = "SubtreeHasLoadingBoundary"),
      (e[(e.IsRootLayout = 16)] = "IsRootLayout"),
      (e[(e.ParentInlinedIntoSelf = 32)] = "ParentInlinedIntoSelf"),
      (e[(e.InlinedIntoChild = 64)] = "InlinedIntoChild"),
      (e[(e.HeadInlinedIntoSelf = 128)] = "HeadInlinedIntoSelf"),
      (e[(e.HeadOutlined = 256)] = "HeadOutlined"),
      e);
    function bi(a) {
      return (a.then(bj), "fulfilled" !== a.status) ? null : a.value;
    }
    let bj = () => {};
    var bk = a.i(35427),
      bl = a.i(22693),
    ...
    function bo(a) {
      if ("string" == typeof a)
        return a.startsWith(aA.PAGE_SEGMENT_KEY)
          ? aA.PAGE_SEGMENT_KEY
          : "/_not-found" === a
            ? "_not-found"
            : br(a);
    ...
    var bs = a.i(49903),
      bt = a.i(69078);
    function bu(a) {
      let b = (0, bs.getDigestForWellKnownError)(a);
      if (b) return b;
      if (process.env.NEXT_DEBUG_BUILD || process.env.__NEXT_VERBOSE_LOGGING) {
        let b = h.workAsyncStorage.getStore();
        (0, bt.printDebugThrownValueForProspectiveRender)(
          a,
          (null == b ? void 0 : b.route) ?? "unknown route",
          bt.Phase.SegmentCollection,
        );
      }
    }
    function bv(a) {
    ...
    async function bw(a, b, e, g, h, i, j) {
      let k = new Map();
      try {
        await (0, bk.createFromReadableStream)((0, bl.streamFromBuffer)(b), {
          findSourceMapURL: d,
          serverConsumerManifest: h,
        }),
          await (0, bm.waitAtLeastOneReactRenderTask)();
      } catch {}
      let l = new AbortController(),
        m = async () => {
          await (0, bm.waitAtLeastOneReactRenderTask)(), l.abort();
        },
        n = [],
        { prelude: o } = await (0, f.prerender)(
          (0, K.jsx)(bA, {
          ...
          g,
          { filterStackFrame: c, signal: l.signal, onError: bu },
        ),
        p = await (0, bl.streamToBuffer)(o);
      k.set("/_tree", p), k.set("/_full", b);
      let q = !1;
      for (let [a, b] of await Promise.all(n))
        k.set(a, b), a.endsWith("__PAGE__") && (q = !0);
      return (
        q || k.set("/todo-remove-fake-segment/__PAGE__", Buffer.alloc(0)), k
      );
    }
    async function bx(a, b, c, e, f, g) {
      try {
        await (0, bk.createFromReadableStream)((0, bl.streamFromBuffer)(a), {
          findSourceMapURL: d,
          serverConsumerManifest: e,
        }),
          await (0, bm.waitAtLeastOneReactRenderTask)();
      } catch {}
      let h = await (0, bk.createFromReadableStream)(
          bF((0, bl.streamFromBuffer)(a)),
      ...
      let { buildId: j, flightRouterState: k, seedData: l, head: m } = i,
        n = h.h,
        o = null !== n ? bi(n) : null,
        [, p] = await bB(j, b, m, bn, o, c),
        q = await bz(p),
        r = { inlined: !1 },
        { node: s } = await by(k, j, b, l, c, "", null, f, g, q, r);
      return r.inlined || (s.hints |= bh.HeadOutlined), s;
    }
    async function by(a, b, c, d, e, f, g, h, i, j, k) {
      let l = null;
      if (null !== d) {
        let a = d[4],
          g = null !== a ? bi(a) : null,
          [, h] = await bB(b, c, d[0], f, g, e);
        l = await bz(h);
      }
      ...
      for (let a in n) {
        ...
        let d = n[a],
          ...
          l = null !== o ? o[a] : null,
          u = bp(f, a, bo(g)),
          v = await by(d, b, c, l, e, u, q ? null : m, h, i, j, k);
        null === p && (p = {}),
          (p[a] = v.node),
          v.node.hints & bh.ParentInlinedIntoSelf
            ? ((q = !0), (r = v.inlinedBytes))
            : !q && v.inlinedBytes < s && (s = v.inlinedBytes);
      }
      t || (s = 0);
      let u = 0;
      q && (u |= bh.InlinedIntoChild);
      let v = q ? r : s;
      return (
        t ||
          k.inlined ||
          !(v + j < i) ||
          ((u |= bh.HeadInlinedIntoSelf), (v += j), (k.inlined = !0)),
        null !== g && v + g < i && ((u |= bh.ParentInlinedIntoSelf), (v += g)),
    ...
    async function bA({
      ...
      let k = await (0, bk.createFromReadableStream)(
          bF((0, bl.streamFromBuffer)(b)),
      ...
      let { buildId: m, flightRouterState: n, seedData: o, head: p } = l,
        ...
        s = (function a(b, c, d, e, f, g, h, i, j, k) {
          ...
          j ||
            (null !== f &&
              i.push(
                (0, bm.waitAtLeastOneReactRenderTask)().then(() =>
                  bB(d, e, f[0], h, s, g),
                ),
              ));
          let t = c[0];
    ...
    async function bB(a, b, d, e, g, h) {
      let i = {
        rsc: d,
        isPartial: await bE(d, h),
        staleTime: b,
        varyParams: g,
      };
      a && (i.buildId = a);
      let j = new AbortController();
      (0, bm.waitAtLeastOneReactRenderTask)().then(() => j.abort());
      let { prelude: k } = await (0, f.prerender)(i, h, {
          filterStackFrame: c,
          signal: j.signal,
          onError: bu,
        }),
        l = await (0, bl.streamToBuffer)(k);
      return "" === e ? ["/_index", l] : [e, l];
    }
    async function bC(a, b, d, e, g, h, i) {
      let j = await bD(a, b, d, e, i),
        k = { rsc: g, isPartial: await bE(g, i), staleTime: d, varyParams: h };
      b && (k.buildId = b);
      let l = new AbortController();
      (0, bm.waitAtLeastOneReactRenderTask)().then(() => l.abort());
      let { prelude: m } = await (0, f.prerender)({ tree: j, head: k }, i, {
          filterStackFrame: c,
          signal: l.signal,
          onError: bu,
        }),
        n = await (0, bl.streamToBuffer)(m);
      return ["/" + aA.PAGE_SEGMENT_KEY, n];
    }
    ...
    a.s(["collectPrefetchHints", 0, bx, "collectSegmentData", 0, bw], 34373);
    var bG = a.i(21751);
    let bH = () => {};
    function bI(a) {
    ...
    globalThis.FinalizationRegistry &&
      (b = new FinalizationRegistry((a) => {
        ...
        b &&
          !b.locked &&
          b.cancel("Response object has been garbage collected").then(bH);
      }));
    let bJ = new Set(["traceparent", "tracestate"]);
    a.i(75700);
    var bK = a.i(276);
    let bL = /[^\t\x20-\x7e]/,
      bM = /[^\t\x20-\x7e]+/g,
      bN = Symbol.for("next-patch");
    function bO(a, b) {
    ...
    async function bP(a, b, c, d, e, f) {
      ...
      return (
        c &&
          (await d.set(
            b,
            { kind: bK.CachedRouteKind.FETCH, data: h, revalidate: e },
            c,
          )),
        await f(),
        new Response(g, {
    ...
    async function bQ(a, b, c, d, e, f, g, h, i, j) {
      let [k, l] = bI(b),
        m = k
          .arrayBuffer()
          .then(async (a) => {
            ...
            null == f || f.set(c, h),
              d &&
                (await e.set(
                  c,
                  { kind: bK.CachedRouteKind.FETCH, data: h, revalidate: g },
                  d,
                ));
          })
          .catch((a) => {
              ...
              globalThis.fetch = (function (
                ...
                let d = async function (d, e) {
                  ...
                  let j = (null == h ? void 0 : h.href) ?? "",
                    ...
                    o = l ? void 0 : performance.timeOrigin + performance.now(),
                    p = b.getStore(),
                    q = c.getStore(),
                    r = q ? (0, i.getCacheSignal)(q) : null;
                  r && r.beginRead();
                  let t = (0, ay.getTracer)().trace(
                    l
                      ? az.NextNodeServerSpan.internalFetch
                      : az.AppRenderSpan.fetch,
                    {
                      hideSpan: m,
                      kind: ay.SpanKind.CLIENT,
                    ...
                    async () => {
                      var b;
                      let c, f, g, h, i, k;
                      if (l || !p || p.isDraftMode) return a(d, e);
                      let m =
                          d &&
                          "object" == typeof d &&
                        ...
                        x = (function (a, b) {
                          ...
                          for (let e = 0; e < a.length; e++) {
                            ...
                            else if (f.length > bG.NEXT_CACHE_TAG_MAX_LENGTH)
                              d.push({
                                tag: f,
                                reason: `exceeded max length of ${bG.NEXT_CACHE_TAG_MAX_LENGTH}`,
                              });
                            else
                              c.push(
                                bL.test(f)
                                  ? f.replace(bM, (a) => encodeURIComponent(a))
                                  : f,
                              );
                            if (c.length > bG.NEXT_CACHE_TAG_MAX_ITEMS) {
                              console.warn(
                      ...
                      let y = null == q ? void 0 : q.implicitTags,
                        z = p.fetchCache;
                      q &&
                        "unstable-cache" === q.type &&
                        (z = "force-no-store");
                      let A = !!p.isUnstableNoStore,
                        B = t("cache"),
                        C = "";
                      "string" == typeof B &&
                        void 0 !== w &&
                      ...
                      let D =
                          ...
                          "force-no-store" === z ||
                          "only-no-store" === z,
                        E = !z && !B && !w && p.forceDynamic;
                      "force-cache" === B && void 0 === w
                        ? (w = !1)
                        : (D || E) && (w = 0),
                        ("no-cache" === B || "no-store" === B) &&
                          (C = `cache: ${B}`),
                        (k = (function (a, b) {
                          try {
                            let c;
                            if (!1 === a) c = bG.INFINITE_CACHE;
                            else if (
                              "number" == typeof a &&
                              !isNaN(a) &&
                              a > -1
                      ...
                      if (
                        (!K &&
                          J &&
                          (p.isBuildTimePrerendering ? (L = !0) : (K = !0)),
                        J && void 0 !== q)
                      )
                        switch (q.type) {
                          case "prerender":
                          ...
                          case "prerender-client":
                            return (
                              r && (r.endRead(), (r = null)),
                              s(q.renderSignal, p.route, "fetch()")
                            );
                        }
                      switch (z) {
                        case "force-no-store":
                      ...
                      if (
                            ...
                            ? "default-no-store" === z
                              ...
                              : A
                                ...
                                : K
                                  ? ((k = 0), (C = "auto no cache"))
                                  : ((C = "auto cache"),
                                    (k = c ? c.revalidate : bG.INFINITE_CACHE))
                            : ((k = bG.INFINITE_CACHE),
                        ...
                        if (0 === k) {
                          ...
                          (0, n.markCurrentScopeAsDynamic)(
                            p,
                            q,
                            `revalidate: 0 fetch ${d} ${p.route}`,
                          );
                        }
                        c && v === k && (c.revalidate = k);
                      }
                      let M = "number" == typeof k && k > 0,
                        { incrementalCache: N } = p,
                        O = !1;
                      if (q)
                        switch (q.type) {
                          case "request":
                              ...
                              if (
                                ...
                                let b =
                                  ...
                                  c = M
                                    ...
                                    : void 0;
                                switch (null == q ? void 0 : q.type) {
                                  case "prerender":
                                  case "prerender-client":
                                  case "validation-client":
                                  case "prerender-runtime":
                                    return bP(a, g, c, N, b, Q);
                                  case "request":
                                  case "prerender-ppr":
                                  case "prerender-legacy":
                                  case "cache":
                      ...
                      if (g && N) {
                        ...
                        if ((O && h && ((a = h.get(g)), (T = !0)), M && !a)) {
                          Q = await N.lock(g);
                          let b = p.isOnDemandRevalidate
                            ? null
                            : await N.get(g, {
                                kind: bK.IncrementalCacheKind.FETCH,
                                revalidate: k,
                                fetchUrl: j,
                                fetchIdx: P,
                                tags: x,
                          ...
                          if (
                            ...
                            (null == b ? void 0 : b.value) &&
                              b.value.kind === bK.CachedRouteKind.FETCH)
                          )
                            if (p.isStaticGeneration && b.isStale) S = !0;
                            else {
                              if (
                                b.isStale &&
                                ((p.pendingRevalidates ??= {}),
                                !p.pendingRevalidates[g])
                              ) {
                                let a = R(!0)
                                  .then(async (a) => ({
                                  ...
                                  .finally(() => {
                                    (p.pendingRevalidates ??= {}),
                                      delete p.pendingRevalidates[g || ""];
                                  });
                                a.catch(console.error),
                                  (p.pendingRevalidates[g] = a);
                              }
                              a = b.value.data;
                            }
                        }
                        if (a) {
                          ...
                          return (
                            Object.defineProperty(b, "url", { value: a.url }), b
                          );
                        }
                      }
                      if (p.isStaticGeneration && e && "object" == typeof e) {
                        let { cache: a } = e;
                        if ("no-store" === a) {
                          if (q)
                            switch (q.type) {
                          ...
                          if (0 === f.revalidate) {
                            if (q)
                              switch (q.type) {
                                ...
                                case "prerender-runtime":
                                case "validation-client":
                                  return s(q.renderSignal, p.route, "fetch()");
                              }
                            (0, n.markCurrentScopeAsDynamic)(
                              p,
                              q,
                      ...
                      if (!g || !S) return R(!1, i);
                      {
                        ...
                        return (
                          (b = c
                            ...
                            .finally(() => {
                              var b;
                              (null == (b = p.pendingRevalidates)
                                ? void 0
                                : b[a]) && delete p.pendingRevalidates[a];
                            })).catch(() => {}),
                          (p.pendingRevalidates[a] = b),
                          c.then((a) => a[1])
                        );
                      }
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__149etk3._.js.map

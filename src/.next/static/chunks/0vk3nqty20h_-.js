(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, r, t) => {
    ...
    let s = {
        [i.INSTANT_VALIDATION_BOUNDARY_NAME]: function ({
          id: e,
          children: r,
        }) {
          let t,
    ...
    function p({ id: e, children: r }) {
      return (0, o.jsx)(m, {
        id: e,
        children: (0, o.jsx)(d, { value: null, children: r }),
      });
    }
  ...
  (e, r, t) => {
                ...
                (0, p.disableSmoothScrollDuringRouteTransition)(
                  () => {
                    ...
                    let e = document.documentElement,
                      r = e.clientHeight;
                    !O(n, r) &&
                      ((e.scrollTop = 0), O(n, r) || n.scrollIntoView());
                  },
    ...
    function T({
      ...
      let B = null;
      if ("u" < typeof window) {
        let { InstantValidationBoundaryContext: r } = e.r(77694);
        B = (0, u.use)(r);
      }
      let U = I[0],
        V = X[r] ?? null,
      ...
      do {
        ...
        if ("u" < typeof window && "string" == typeof B) {
          let { RenderValidationBoundaryAtThisLevel: r } = e.r(77694);
          j = (0, i.jsx)(r, { id: B, children: j });
        }
        let T = (0, i.jsxs)(
          s.TemplateContext.Provider,
          { value: j, children: [o, l, c] },
          g,
        );
        (T = (0, i.jsx)(
          u.Activity,
  ...
  (e, r, t) => {
    ...
    function _(e, r) {
      ...
      for (let r of ((e.value = t), (e.status = "fulfilled"), e.resolvers))
        r(t);
      e.resolvers = [];
    }
  },
        ...
        switch (a.type) {
          ...
          case "prerender-runtime":
            return (function (e, r, t, n) {
              let a = R(
                  null !== t ? (0, l.createVaryingSearchParams)(t, e) : e,
                ),
                { stagedRendering: o } = r;
              if (!o) return a;
          ...
          case "request":
            if (i.asyncApiPromises && i.validationSamples)
              return (function (r, t, n, a, o) {
                let { createExhaustiveParamsProxy: l } = e.r(18450),
                      ...
                      d.wellKnownProperties.has(e) ||
                        (r.has(e) &&
                          Object.defineProperty(o, e, {
                            get() {
                              let r = (0, d.describeStringPropertyAccess)(
                                "params",
                                e,
                              );
    ...
    function u({ Component: r, serverProvidedParams: t }) {
      ...
      if (null !== t) (c = t.searchParams), (s = t.params);
        ...
        (s = null !== e ? e.parentParams : {}),
          (c = (0, l.urlSearchParamsToParsedUrlQuery)(
            (0, o.use)(i.SearchParamsContext),
          ));
      }
      if ("u" < typeof window) {
        let t,
        ...
        t = o(c);
        let { createParamsFromClient: l } = e.r(41489);

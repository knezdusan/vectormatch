...
// The "server-only" import prevents any Client Component from accidentally
// importing this module (which pulls in pg → Node.js built-ins).
...
// Re-export shared types and constants so existing server-side imports
// (JobListContent.tsx, JobDetail.tsx, etc.) continue to work unchanged.
export type {
  JobEmploymentType,
  JobFilters,
  JobRemoteScope,

    ...
    WITH job_meta AS (
      SELECT ats_slug, title, remote_scope, location_name,
             COALESCE(is_fenced, (
               ...
               OR COALESCE(location_name, '') ~* 'Remote\s*[;,-]\s*(Argentina|Brazil|Colombia|Mexico|Canada|Chile|Peru|Uruguay|Ecuador|Costa Rica|Panama|Guatemala|Germany|France|Spain|Italy|Portugal|Netherlands|Holland|Poland|Ukraine|Romania|Ireland|Sweden|Norway|Denmark|Finland|Iceland|Belgium|Austria|Switzerland|Czech Republic|Czechia|Greece|Bulgaria|Hungary|Slovakia|Slovenia|Croatia|Serbia|Estonia|Latvia|Lithuania|Luxembourg|Malta|Cyprus|India|Pakistan|Bangladesh|Sri Lanka|Nepal|Philippines|Vietnam|Indonesia|Malaysia|Singapore|Thailand|Taiwan|Hong Kong|Japan|South Korea|Korea|China|Australia|New Zealand|South Africa|Nigeria|Kenya|Egypt|Morocco|Ghana|Israel|UAE|Dubai|Saudi Arabia|Turkey|Qatar|Bahrain|Kuwait|Oman|Jordan|Lebanon|United Kingdom|UK|England|Scotland|Wales)'
               OR COALESCE(location_name, '') ~* 'Remote\s*,\s*[A-Za-z]{2}\b'
               OR COALESCE(location_name, '') ~* '(European Union|NAMER|EMEA|APAC|LATAM|North America|South America|Central America|Americas|Middle East|MENA|GCC|Balkans|Eastern Europe|Western Europe|Nordics|Scandinavia|DACH|Benelux|ANZ|Australasia|Oceania)'
               OR COALESCE(location_name, '') ~* '(United States|USA|Canada|Argentina|Brazil|Colombia|Mexico|Chile|Peru|Uruguay|Ecuador|Costa Rica|Panama|Guatemala|Germany|France|Spain|Italy|Portugal|Netherlands|Holland|Poland|Ukraine|Romania|Ireland|Sweden|Norway|Denmark|Finland|Iceland|Belgium|Austria|Switzerland|Czech Republic|Czechia|Greece|Bulgaria|Hungary|Slovakia|Slovenia|Croatia|Serbia|Estonia|Latvia|Lithuania|Luxembourg|Malta|Cyprus|India|Pakistan|Bangladesh|Sri Lanka|Nepal|Philippines|Vietnam|Indonesia|Malaysia|Singapore|Thailand|Taiwan|Hong Kong|Japan|South Korea|Korea|China|Australia|New Zealand|South Africa|Nigeria|Kenya|Egypt|Morocco|Ghana|Israel|UAE|Dubai|Saudi Arabia|Turkey|Qatar|Bahrain|Kuwait|Oman|Jordan|Lebanon|United Kingdom|England|Scotland|Wales)'
